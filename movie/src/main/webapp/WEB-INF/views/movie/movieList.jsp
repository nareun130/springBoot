  ...
  <div class="container w-75 mt-5 mx-auto">
    ...
    <ul id='list-group'>
      <c:forEach var="movie" items="${movielist}" varStatus="status">
        <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center"><a href="/movie/${movie.mid}" class="text-decoration-none"> ${status.count}) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${movie.title} </a> <a href="/movie/delete/${movie.mid}"><span class="badge bg-secondary">&times;</span></a></li>
      </c:forEach>
    </ul>
    ...
    <!-- 수정 안해도 됨. -->
    <button class="btn btn-outline-info mb-3" type="button" data-bs-toggle="collapse" data-bs-target="#addForm" aria-expanded="false" aria-controls="addForm">영화 등록</button>
    ...
    <div class="collapse" id="addForm">
      <div class="card card-body">
        <form method="post" action="/movie/add" enctype="multipart/form-data">
          ...
          <input type="number" name="rtime" class="form-control" />
          <label class="form-label">즐거리</label>
